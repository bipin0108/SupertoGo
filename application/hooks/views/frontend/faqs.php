...
<!-- Mirrored from demo.themefisher.com/themefisher/biztrox/faqs.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Sep 2019 11:21:54 GMT -->
<head>
  <meta charset="utf-8">
  <title>BIZTROX</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="text-white font-weight-bold">FAQs</h2>
                <ol class="breadcrumb">
                    <li>
        ...
        <div class="row justify-content-between">
            <div class="col-lg-7">
                ...
                <div id="accordion" class="mb-md-50">
                    ...
                    <div class="card border-0 mb-4">
                        <div class="card-header bg-gray border p-0">
                            <a class="card-link h5 d-block tex-dark mb-0 py-10 px-4" data-toggle="collapse" href="#collapseOne">
                                <i class="ti-minus text-primary mr-2"></i> Does It Cost Anything To Use The Mobile App?
                            </a>
                        </div>
                        <div id="collapseOne" class="collapse show" data-parent="#accordion">
                            <div class="card-body">
                                ...
                                non proident sunt culpa qui officia deserunt mollit anim id est laborum. sed perspiciatis
                                unde omnisiste natus error sit voluptatem accusantium.
                            </div>
                        </div>
                    </div>
                    <div class="card border-0 mb-4">
                        <div class="card-header bg-gray border p-0">
                            <a class="collapsed card-link h5 d-block tex-dark mb-0 py-10 px-4" data-toggle="collapse" href="#collapseTwo">
                                <i class="ti-plus text-primary mr-2"></i> How Do I Find Your Offices And Payment Locations?
                            </a>
                        </div>
                    ...
                    <div class="card border-0 mb-4">
                        <div class="card-header bg-gray border p-0">
                            <a class="collapsed card-link h5 d-block tex-dark mb-0 py-10 px-4" data-toggle="collapse" href="#collapseThree">
                                <i class="ti-plus text-primary mr-2"></i> How Do I Get The Mobile App For My Phone?
                            </a>
                        </div>
                    ...
                    <div class="card border-0 mb-4">
                        <div class="card-header bg-gray border p-0">
                            <a class="collapsed card-link h5 d-block tex-dark mb-0 py-10 px-4" data-toggle="collapse" href="#collapseFour">
                                <i class="ti-plus text-primary mr-2"></i> What Is Your Company Mission
                            </a>
                        </div>
                    ...
                    <div class="card border-0 mb-4">
                        <div class="card-header bg-gray border p-0">
                            <a class="collapsed card-link h5 d-block tex-dark mb-0 py-10 px-4" data-toggle="collapse" href="#collapseFive">
                                <i class="ti-plus text-primary mr-2"></i> Can I Get Basic Consltancy Online Free Of Costs?
                            </a>
                        </div>
            ...
            <div class="col-lg-4">
                <div class="rounded p-5 box-shadow position-sticky" style="top:50px;">
                    ...
                    <form action="#" class="row">
                        <div class="col-lg-12">
                            <h4 class="mb-20">Ask Your Questions</h4>
                        </div>
                        <div class="col-lg-12">
                        ...
                        <div class="col-lg-12">
                            <textarea name="question" id="question" class="form-control pt-2" placeholder="Your Question Here..." style="height: 130px;"></textarea>
                        </div>
                        <div class="col-lg-12">
                            <button class="btn btn-primary" type="submit" value="send">Ask Question</button>
                        </div>
                    </form>
                </div>
            </div>
