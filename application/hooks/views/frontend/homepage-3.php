...
<!-- Mirrored from demo.themefisher.com/themefisher/biztrox/homepage-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Sep 2019 11:20:46 GMT -->
<head>
  <meta charset="utf-8">
  <title>BIZTROX</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 align-self-center">
                ...
                <a href="#" class="btn btn-primary mb-md-50">Explore More</a>
            </div>
            <div class="col-lg-6">
                <div class="row">
                    <!-- service-item -->
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="about-slider">
                    <img class="img-fluid" src="images/about/about-1.jpg" alt="about-image">
                    <img class="img-fluid" src="images/about/about-2.jpg" alt="about-image">
                    <img class="img-fluid" src="images/about/about-3.jpg" alt="about-image">
                </div>
            </div>
        </div>
    </div>
...
<section class="cta overlay-dark section-sm" style="background-image: url(images/background/cta-2.jpg);">
    <div class="container">
        <div class="row">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                <div class="card text-center p-3">
                    <img class="card-img-top rounded" src="images/team/team-1.jpg" alt="team member image">
                    <div class="card-body pb-0">
                        ...
                        <ul class="list-inline">
                            <li class="list-inline-item">
                                <a href="#" class="text-color d-inline-block py-1 px-3">
            ...
            <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                <div class="card text-center p-3">
                    <img class="card-img-top rounded" src="images/team/team-2.jpg" alt="team member image">
                    <div class="card-body pb-0">
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="card text-center p-3">
                    <img class="card-img-top rounded" src="images/team/team-3.jpg" alt="team member image">
                    <div class="card-body pb-0">
...
<!-- consultation -->
<section class="consultation section-sm" style="background-image: url(images/background/consultation.jpg);">
    <div class="container">
        <div class="row">
...
<section class="bg-primary py-4">
    <div class="container">
        <div class="client-logo-slider align-self-center">
            <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset" src="images/client-logo/client-logo-1-white.png" alt="client-logo"></a>
            <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset" src="images/client-logo/client-logo-2-white.png" alt="client-logo"></a>
            <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset" src="images/client-logo/client-logo-3-white.png" alt="client-logo"></a>
            <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset" src="images/client-logo/client-logo-4-white.png" alt="client-logo"></a>
            <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset" src="images/client-logo/client-logo-5-white.png" alt="client-logo"></a>
            <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset" src="images/client-logo/client-logo-1-white.png" alt="client-logo"></a>
            <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset" src="images/client-logo/client-logo-2-white.png" alt="client-logo"></a>
            <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset" src="images/client-logo/client-logo-3-white.png" alt="client-logo"></a>
            <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset" src="images/client-logo/client-logo-4-white.png" alt="client-logo"></a>
...
<!-- Mirrored from demo.themefisher.com/themefisher/biztrox/homepage-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Sep 2019 11:21:02 GMT -->
</html>