                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="signup-form">
                                <form action="<?php echo base_url(); ?>confirm-otp" method="post" class="row">
                                    <div class="col-lg-12">
                                        <h4>Confirm Verification Code</h4>
                                    </div>
                                    <div class="col-lg-12">
                                        <?php echo form_error('otp'); ?>
                                        <input type="text" class="form-control" id="otp" name="otp" placeholder="Verification Code" value="<?php echo set_value('otp'); ?>">
                                    </div>
                                    <div class="col-sm-4">
