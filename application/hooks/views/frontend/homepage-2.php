...
<!-- Mirrored from demo.themefisher.com/themefisher/biztrox/homepage-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Sep 2019 11:20:42 GMT -->
<head>
  <meta charset="utf-8">
  <title>BIZTROX</title>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 align-self-center">
                <img class="img-fluid w-100" src="images/chart.png" alt="chart">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 px-0">
                <div class="p-sm-5 px-3 py-5" style="background: #303032;">
                    ...
                    <p class="text-white mb-40">Excepteur sint occaecat cupidatat non proident sunt culpa qui officia deserunt mollit anim id est laborum.
                    </p>
                    <!-- about item -->
                    <div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                <div class="card">
                    <img class="card-img-top" src="images/blog/blog-1.jpg" alt="news-thumbnail">
                    <div class="card-body p-0">
                      <div class="p-3 border-bottom">
                        <h6 class="text-primary">Dec 20, 2017</h6>
                        <a href="blog-single.html" class="h4 card-title font-primary text-dark">Cras sed elit sit amet.</a>
                      ...
                      <a href="#" class="card-link d-inline-block text-color p-2"><i class="text-primary mr-2 ti-comments-smiley"></i>30 Comments</a>
                      <a href="#" class="card-link d-inline-block text-color p-2 px-3 float-right border-left"><i class="text-primary ti-share"></i></a>
                    </div>
                </div>
            </div>
            <!-- blog item -->
            <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                <div class="card">
                    <img class="card-img-top" src="images/blog/blog-2.jpg" alt="news-thumbnail">
                    <div class="card-body p-0">
                      <div class="p-3 border-bottom">
                        <h6 class="text-primary">Dec 20, 2017</h6>
                        <a href="blog-single.html" class="h4 card-title font-primary text-dark">Cras sed elit sit amet.</a>
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="card">
                    <img class="card-img-top" src="images/blog/blog-3.jpg" alt="news-thumbnail">
                    <div class="card-body p-0">
                      <div class="p-3 border-bottom">
                        <h6 class="text-primary">Dec 20, 2017</h6>
                        <a href="blog-single.html" class="h4 card-title font-primary text-dark">Cras sed elit sit amet.</a>
...
<!-- Mirrored from demo.themefisher.com/themefisher/biztrox/homepage-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Sep 2019 11:20:46 GMT -->
</html>