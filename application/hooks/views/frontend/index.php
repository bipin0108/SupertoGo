<section>
    <div class="hero-slider position-relative">
        <div class="hero-slider-item py-160" style="background-image: url(<?php echo SITE_URL; ?>assets/images/banner/banner-1.jpg);" data-icon="ti-comments" data-text="Consultation">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
        ...
        <div class="hero-slider-item py-160" style="background-image: url(<?php echo SITE_URL; ?>assets/images/banner/banner-2.jpg);" data-icon="ti-bar-chart" data-text="Marketting">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="hero-content">
        ...
        <div class="hero-slider-item py-160" style="background-image: url(<?php echo SITE_URL; ?>assets/images/banner/banner-3.jpg);" data-icon="ti-money" data-text="Finance">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="hero-content">
        ...
        <div class="hero-slider-item py-160" style="background-image: url(<?php echo SITE_URL; ?>assets/images/banner/banner-4.jpg);" data-icon="ti-package" data-text="Human Resources">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="hero-content">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
                <div class="card text-center">
                    ...
                    <div class="card-img-wrapper">
                        <img class="card-img-top rounded-0" src="<?php echo SITE_URL; ?>assets/images/service/service-1.jpg" alt="service-image">
                    </div>
                    <div class="card-body p-0">
                        ...
                        <a href="service-single.php" class="btn btn-secondary translateY-25">Read More</a>
                    </div>
                </div>
            </div>
            <!-- service item -->
            <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
                <div class="card text-center">
                    ...
                    <div class="card-img-wrapper">
                        <img class="card-img-top rounded-0" src="<?php echo SITE_URL; ?>assets/images/service/service-2.jpg" alt="service-image">
                    </div>
                    <div class="card-body p-0">
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="card text-center">
                    ...
                    <div class="card-img-wrapper">
                        <img class="card-img-top rounded-0" src="<?php echo SITE_URL; ?>assets/images/service/service-3.jpg" alt="service-image">
                    </div>
                    <div class="card-body p-0">
...
<section class="about section-sm overlay" style="background-image: url(<?php echo SITE_URL; ?>assets/images/background/about-bg.jpg);">
    <div class="container">
        <div class="row">
...
<section class="section">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-7">
                <div class="mb-40">
                    <p class="text-dark">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed eiusmod tempor incididunt laboris nisi
                        ut aliquip ex ea commodo consequat. </p>
                    <p class="text-dark mb-30">Duis aute irure dolor in reprehenderit voluptate velit esse cillum dolore fugiat nulla pariatur.Excepteur
                        sint ocaecat cupidatat non proident sunt culpa qui officia deserunt mollit anim id est laborum. sed
                        perspiciatis unde omnisiste natus error sit voluptatem accusantium.doloremque ladantium totam rem
                        aperieaque ipsa quae ab illo inventore.veritatis. et quasi architecto beatae vitae dicta sunt explicabo.</p>
                </div>
                <!-- fun-fact -->
                <div class="mb-md-50">
                    <div class="row">
        ...
        <div class="row work-slider">
            <div class="col-lg-3 px-0">
                <div class="work-slider-image">
                    <img class="img-fluid w-100" src="<?php echo SITE_URL; ?>assets/images/works/work-1.jpg" alt="work-image">
                    <div class="image-overlay">
                        <a class="popup-image" data-effect="mfp-zoom-in" href="<?php echo SITE_URL; ?>assets/images/works/work-1.jpg">
                            <i class="ti-search"></i>
                        </a>
                        <a class="h4" href="project-single.php">Cras Sed Elit Sit Amet.</a>
                        <p>by Admin</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 px-0">
                <div class="work-slider-image">
                    <img class="img-fluid w-100" src="<?php echo SITE_URL; ?>assets/images/works/work-2.jpg" alt="work-image">
                    <div class="image-overlay">
                        <a class="popup-image" data-effect="mfp-zoom-in" href="<?php echo SITE_URL; ?>assets/images/works/work-2.jpg">
                            <i class="ti-search"></i>
                        </a>
                        <a class="h4" href="project-single.php">Cras Sed Elit Sit Amet.</a>
                        <p>by Admin</p>
            ...
            <div class="col-lg-3 px-0">
                <div class="work-slider-image">
                    <img class="img-fluid w-100" src="<?php echo SITE_URL; ?>assets/images/works/work-3.jpg" alt="work-image">
                    <div class="image-overlay">
                        <a class="popup-image" data-effect="mfp-zoom-in" href="<?php echo SITE_URL; ?>assets/images/works/work-3.jpg">
                            <i class="ti-search"></i>
                        </a>
                        <a class="h4" href="project-single.php">Cras Sed Elit Sit Amet.</a>
                        <p>by Admin</p>
            ...
            <div class="col-lg-3 px-0">
                <div class="work-slider-image">
                    <img class="img-fluid w-100" src="<?php echo SITE_URL; ?>assets/images/works/work-4.jpg" alt="work-image">
                    <div class="image-overlay">
                        <a class="popup-image" data-effect="mfp-zoom-in" href="<?php echo SITE_URL; ?>assets/images/works/work-4.jpg">
                            <i class="ti-search"></i>
                        </a>
                        <a class="h4" href="project-single.php">Cras Sed Elit Sit Amet.</a>
                        <p>by Admin</p>
...
<section class="mission section">
    <div class="container">
        <div class="row">
            ...
            <!-- chart -->
            <div class="col-lg-6">
                <img src="<?php echo SITE_URL; ?>assets/images/chart.png" alt="chart" class="img-fluid w-100">
            </div>
        </div>
    </div>
</section>
...
<!-- promo-video -->
<section class="promo-video overlay section" style="background-image: url(<?php echo SITE_URL; ?>assets/images/background/promo-video.jpg);">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5 col-md-5 pr-0 align-self-center">
                <img class="img-fluid w-100" src="<?php echo SITE_URL; ?>assets/images/client.png" alt="clients-image">
            </div>
...
<section class="cta overlay-primary py-50 text-center text-lg-left" style="background-image: url(<?php echo SITE_URL; ?>assets/images/background/cta.jpg);">
        <div class="container">
    ...
    <div class="container">
        <div class="row justify-content-center">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-0">
                        <div class="d-flex">
                            ...
                            <div class="p-3">
                                <a href="blog-single.php" class="h4 font-primary text-dark">Cras sed elit sit amet.</a>
                                <p>by Admin</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                <div class="card">
                    <div class="card-img-wrapper overlay-rounded-top">
                        <img class="card-img-top" src="<?php echo SITE_URL; ?>assets/images/blog/blog-2.jpg" alt="blog-thumbnail">
                    </div>
                    <div class="card-body p-0">
                        <div class="d-flex">
                            <div class="py-3 px-4 border-right text-center">
