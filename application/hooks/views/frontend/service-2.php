...
<!-- Mirrored from demo.themefisher.com/themefisher/biztrox/service-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Sep 2019 11:21:28 GMT -->
<head>
  <meta charset="utf-8">
  <title>BIZTROX</title>
...
<!-- cta -->
<section class="cta py-50 overlay-white" style="background-image: url(images/background/cta.jpg);">
    <div class="container">
        <div class="row">
            <div class="col-lg-9 text-center text-lg-left mb-3 mb-lg-0">
                <h3 class="text-dark">We have 15 years experience in consultancy Biztrox give the smart solution for your business</h3>
            </div>
            <div class="col-lg-3 text-lg-right text-center align-self-center">
                <a href="#" class="btn btn-sm btn-primary">Send Free Enquiry</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-sm-6 mb-5">
                <div class="card text-center">
                    ...
                    <div class="card-body p-0">
                        <i class="square-icon translateY-33 rounded rounded ti-thought"></i>
                        <p class="card-text mx-2 mb-0">Lorem ipsum dolor amet consecte tur adipisicing elit sed done eius mod tempor enim ad minim veniam quis nostrud.</p>
                        <a href="service-single.html" class="btn btn-secondary translateY-25">Read More</a>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-sm-6 mb-5">
                <div class="card text-center">
                    ...
                    <div class="card-body p-0">
                        <i class="square-icon translateY-33 rounded rounded ti-server"></i>
                        <p class="card-text mx-2 mb-0">Lorem ipsum dolor amet consecte tur adipisicing elit sed done eius mod tempor enim ad minim veniam quis nostrud.</p>
                        <a href="service-single.html" class="btn btn-secondary translateY-25">Read More</a>
                    </div>
                </div>
...
<!-- Mirrored from demo.themefisher.com/themefisher/biztrox/service-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Sep 2019 11:21:29 GMT -->
</html>