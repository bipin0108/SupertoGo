                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="signup-form">
                                <form action="<?php echo base_url(); ?>register" method="post" class="row">
                                    <div class="col-lg-12">
                                        <h4>Sign Up</h4>
                                    ...
                                    <div class="col-lg-12">
                                        <?php echo form_error('re-pin'); ?>
                                        <input type="password" class="form-control" id="re-pin" name="re-pin" placeholder="Confirm Pin" value="<?php echo set_value('re-pin'); ?>">
                                    </div>
                                    <div class="col-lg-12">
                                        <?php echo form_error('referral_moblie'); ?>
                                        <input type="text" class="form-control" id="referral_moblie" name="referral_moblie" placeholder="Referral Moblie No" value="<?php echo set_value('referral_moblie'); ?>">
                                    </div>
                                    <div class="col-sm-4">
