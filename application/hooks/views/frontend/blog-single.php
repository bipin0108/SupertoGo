...
<!-- Mirrored from demo.themefisher.com/themefisher/biztrox/blog-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Sep 2019 11:22:31 GMT -->
<head>
  <meta charset="utf-8">
  <title>BIZTROX</title>
        ...
        <div class="row">
            <div class="col-lg-8 py-100">
                <div class="border rounded bg-white">
                    <img class="img-fluid w-100 rounded-top" src="images/blog/blog-single.jpg" alt="blog-image">
                    <div class="p-4">
                        ...
                        <div class="row mb-20">
                            <div class="col-sm-5 pr-sm-0 align-self-center">
                                <img class="img-fluid w-100 rounded mr-4 mb-4 mb-sm-0" src="images/blog/blog-testimonial.jpg" alt="client image">
                            </div>
                            <div class="col-sm-7">
                                <i class="text-color d-block mb-10 ti-quote-left" style="font-size: 22px"></i>
                                <p class="text-dark mb-20">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod temporincididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrudexercitation.</p>
                                <h5 class="text-dark">John Doe</h5>
                                <h6 class="text-color">Chairman</h6>
                            </div>
                        </div>
                        <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex.Commodo consequat.</p>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="d-flex mb-4">
                        <div class="mr-3">
                            <img class="img-fluid rounded w-100" src="images/blog/comment-1.jpg" alt="user-image">
                        </div>
...
<!-- Mirrored from demo.themefisher.com/themefisher/biztrox/blog-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Sep 2019 11:22:38 GMT -->
</html>