...
<?php 
$obj=&get_instance();
$subadmin=$obj->v_subadminmodel->get_all_vendor_subadmin(); 
?> 
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
           <div class="box box-primary">
            <div class="box-header">
              ...
              <?php endif ?>
             <a href="<?php echo base_url('vendor/create-vendor-subadmin'); ?>" class="btn btn-primary pull-right" >Add</a>
            </div>
            <!-- /.box-header -->
                ...
                <?php foreach($subadmin as $row) { ?>
                  ...
                  <td>
                     <?php if($row->profile_image == ''){ ?>
                      ...
                      <?php }else{ ?>
                      <img class=" img-responsive" style="height:40px;width:40px" src="<?php echo IMG_PATH.'vendor_profiles/'.$row->profile_image; ?>">
                    <?php } ?>
                  </td>
                    ...
                    <td>
                      <a class="btn btn-sm btn-primary" href="<?php echo base_url('vendor/vendor-subadmin-role-permission/'.$row->vendor_id); ?>">
                        <i class="fa fa-unlock"></i>
                      </a>
                      <a class="btn btn-sm btn-primary" href="<?php echo base_url('vendor/edit-vendor-subadmin/'.$row->vendor_id); ?>">
...
<div class="modal fade in" id="modalDel">
  <div class="modal-dialog" >
    <div class="modal-content">
      ...
      <form method="post" action="<?php echo base_url('vendor/trash-vendor-subadmin'); ?>" id="frmDel">
  ...
  $(document).ready(function(){
        ...
        $(document).on('click', '.active_deactive', function(){
          ...
          var is_value = $(this).data('is_value');
           $.ajax({
                 url:"<?php echo base_url(); ?>vendor/vendor_subadmin_active_deactive_ajax",
                 method:"POST",
