    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="box box-primary">
          ...
          <?php endif ?>
          <!-- START add  form -->
          <?php echo form_open('admin/add-special-alert'); ?>
            <div class="box-body">
              <!-- start -->
              <div class="col-md-12">
                <div class="col-md-12">
              ...
              <div class="col-md-12">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea rows="4" class="form-control" id="en_description" name="en_description"  placeholder="Description [English]" autocomplete="off" ><?php echo set_value('en_description') ?></textarea>
                    <?php echo form_error('en_description'); ?>
                  </div>
                  <div class="form-group">
                    <label>Description [Hindi]</label>
                    <textarea rows="4" class="form-control" id="hi_description" name="hi_description" placeholder="Description [Hindi]" autocomplete="off" ><?php echo set_value('hi_description') ?></textarea>
                    <?php echo form_error('hi_description'); ?>
                  </div>
                  <div class="form-group">
                    <label>Description [Marathi]</label>
                    <textarea rows="4" class="form-control" id="mr_description" name="mr_description" placeholder="Description [Marathi]" autocomplete="off" ><?php echo set_value('mr_description') ?></textarea>
