        ...
        <div class="col-md-3" >
          ...
          <div class="box box-primary" id="element_overlap">
            ...
            <?php if($user['profile_image'] == ''){ ?>
              ...
              <?php }else{ ?>
              <img class="profile-user-img img-responsive img-circle profileImgUrl" style="height:100px;width:100px" src="<?php echo base_url('uploads/profiles/'.$user['profile_image']); ?>">
            <?php } ?>
