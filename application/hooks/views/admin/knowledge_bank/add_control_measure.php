    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="box box-primary">
          ...
          <?php endif ?>
          <!-- START add control measure form -->
            <?php echo form_open_multipart('admin/add-control-measure'); ?>
            <div class="box-body">
              ...
              <div class="col-md-12">
                  <div class="col-md-4">
                     <div class="form-group">
                      ...
                      <input type="text" name="en_dose" value="<?php echo set_value('en_dose') ?>" class="form-control" placeholder="Dose [English]" autocomplete="off">
              ...
              <div class="col-md-12">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea rows="4" class="form-control" id="en_cm_description" name="en_cm_description" autocomplete="off" placeholder="Description [English]" ><?php echo set_value('en_cm_description') ?></textarea>
                ...
                <div class="col-md-12">  
                  <div class="form-group">
                    ...
                    <textarea rows="4" class="form-control" id="hi_cm_description" name="hi_cm_description" autocomplete="off" placeholder="Description [Hindi]" ><?php echo set_value('hi_cm_description') ?></textarea>
                ...
                <div class="col-md-12">  
                  <div class="form-group">
                    ...
                    <textarea rows="4" class="form-control" id="mr_cm_description" name="mr_cm_description" autocomplete="off" placeholder="Description [Marathi]" ><?php echo set_value('mr_cm_description') ?></textarea>
