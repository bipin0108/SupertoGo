...
$obj=&get_instance();
$control_measure = $obj->knowledgebankmodel->get_all_technical($subtopic_id); 
$subtopic = $obj->knowledgebankmodel->get_kb_subtopic_by_id($subtopic_id); 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <a href="<?php echo base_url('admin/list-bank-subtopic/'.$subtopic['topic_id']); ?>" class="btn btn-primary pull-right" > <i class="fa fa-angle-double-left" aria-hidden="true"></i>  Back to SubTopic</a>
      </h1>
            ...
            <div class="box-header">
              ...
              <?php endif ?>
                ...
                <?php if($role_permission->is_add == 1){ ?>  
                  <a href="<?php echo base_url('admin/create-technical/'.$subtopic_id); ?>" class="btn btn-primary pull-right" ><i class="fa fa-plus"></i> Add Technical Name</a>
                <?php } ?>
                </h3>
            </div>
            <!-- /.box-header -->
                  ...
                  <tr>
                    ...
                    <td>
                        <?php if($role_permission->is_edit == 1){ ?>
                          <a class="btn btn-sm btn-primary" href="<?php echo base_url('admin/edit-technical/'.$subtopic_id.'/'.$row->id); ?>">
                        ...
                        <?php if($role_permission->is_view == 1){ ?>  
                          <a class="btn btn-sm btn-primary" href="<?php echo base_url('admin/control-measure-list/'.$row->id); ?>">
...
<div class="modal fade in" id="modalDel">
  <div class="modal-dialog" >
    <div class="modal-content">
      ...
      <form method="post" action="<?php echo base_url('admin/trash-technical'); ?>" id="frmDel">
