...
<?php 
$obj=&get_instance();
$areaunit=$obj->areaunitmodel->get_all_areaunit(); 
?> 
           ...
           <div class="box box-primary">
            <div class="box-header">
              ...
              <?php if($role_permission->is_add == 1){ ?>
                <a href="<?php echo base_url('admin/create-area-unit'); ?>" class="btn btn-primary pull-right" ><i class="fa fa-plus"></i> Add Area Unit</a>
              <?php } ?>  
            </div>
            <!-- /.box-header -->
                  ...
                  <tr>
                    ...
                    <td style="display: inline-flex;">
                      <?php if($role_permission->is_edit == 1){ ?>
                        <a class="btn btn-sm btn-primary" href="<?php echo base_url('admin/edit-area-unit/'.$row->id); ?>" style="margin-right: 5px;">
...
<div class="modal fade in" id="modalDel">
  <div class="modal-dialog" >
    <div class="modal-content">
      ...
      <form method="post" action="<?php echo base_url('admin/trash-area-unit'); ?>" id="frmDel">
