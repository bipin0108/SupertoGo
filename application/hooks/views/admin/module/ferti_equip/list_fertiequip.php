...
<?php 
$obj=&get_instance();
$equipment=$obj->fertiequipmentmodel->get_all_fertiequipment(); 
?> 
  <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>Fertigation Equipment</h1>
    </section>
    <!-- Main content --> 
           ...
           <div class="box box-primary">
            <div class="box-header">
              ...
              <?php if($role_permission->is_add == 1){ ?>
                <a href="<?php echo base_url('admin/create-fertigation-equipment'); ?>" class="btn btn-primary pull-right" ><i class="fa fa-plus"></i> Add Equipment</a>
              <?php } ?>  
            </div>
            <!-- /.box-header -->
                  ...
                  <tr>
                    ...
                    <td>
                      <?php if($role_permission->is_edit == 1){ ?>
                        <a class="btn btn-sm btn-primary" href="<?php echo base_url('admin/edit-fertigation-equipment/'.$row->id); ?>">
...
<div class="modal fade in" id="modalDel">
  <div class="modal-dialog" >
    <div class="modal-content">
      ...
      <form method="post" action="<?php echo base_url('admin/trash-fertigation-equipment'); ?>" id="frmDel">
