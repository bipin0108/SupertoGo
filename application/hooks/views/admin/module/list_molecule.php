...
<?php 
$obj=&get_instance();
$molecule=$obj->moleculemodel->get_all_molecule(); 
?> 
           ...
           <div class="box box-primary">
            <div class="box-header">
              ...
              <?php if($role_permission->is_add == 1){ ?>
                <a href="<?php echo base_url('admin/create-molecule'); ?>" class="btn btn-primary pull-right" ><i class="fa fa-plus"></i> Add Molecule</a>
              <?php } ?>
            </div>
            <!-- /.box-header -->
