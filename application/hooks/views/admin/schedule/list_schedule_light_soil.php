              ...
              <div class="nav-tabs-custom" id="element_overlap1">
                ...
                <div class="tab-content">
                  <?php $i=0; foreach ($month_arr as $idx => $month_name) { 
                    $i++;
                    $schedule_data = $this->schedulemodel->get_lightsoil_schedule_by_month($month_name);
                  ?>
                    ...
                    <h3 style="margin:5px 0 5px 0;">Schedule of <?php echo $month_name; ?>
                      <?php if(count($schedule_data) == 0){ ?>
                        <?php if($role_permission->is_add == 1){ ?>
                          <a href="<?php echo base_url('admin/create-light-soil-schedule/'.$month_name); ?>" class="btn btn-primary pull-right" style="margin-right: 5px;">
                            ...
                            <tr>
                              ...
                              <td style="display: inline-flex;">
                                <?php if($role_permission->is_edit == 1){ ?>
                                    <a class="btn btn-sm btn-primary" href="<?php echo base_url('admin/edit-light-soil-schedule/'.$row->id); ?>" style="margin-right: 5px;">
...
<div class="modal fade in" id="modalDel">
  <div class="modal-dialog" >
    <div class="modal-content">
      ...
      <form method="post" action="<?php echo base_url('admin/trash-light-soil-schedule'); ?>" id="frmDel">
