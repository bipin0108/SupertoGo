           ...
           <div class="box box-primary">
            <div class="box-header">
              ...
              <?php if($role_permission->is_add == 1){ ?>
                <a href="<?php echo base_url('admin/create-webinar'); ?>" class="btn btn-primary pull-right" ><i class="fa fa-plus"></i> Add Webinar</a>
              <?php } ?>  
              </h4>
            </div>
            <!-- /.box-header -->
              ...
              <table id="table" class="table table-bordered table-striped">
                ...
                <?php foreach($kb_subcate as $row) { ?>
                  <tr>
                    <td><?php echo $i++; ?></td>
                    <td>
                       <img class=" img-responsive" height="55px" src="<?php echo IMG_PATH.'webinar/'.$row->base_image; ?>"  >
                    </td>
                    <td>
                    ...
                    <td>
                      <?php if($role_permission->is_edit == 1){ ?>
                        <a class="btn btn-sm btn-primary" href="<?php echo base_url('admin/edit-webinar/'.$row->id); ?>"><i class="fa fa-edit"></i></a>
                      <?php } ?>  
                      ...
                      <?php if($role_permission->is_view == 1){ ?>  
                        <a class="btn btn-sm btn-primary" href="<?php echo base_url('admin/webinar-video-list/'.$row->id); ?>">Video</a>
                       <?php } ?>  
                    </td>
                  </tr>                  
                <?php } ?>    
...
<div class="modal fade in" id="modalDel">
  <div class="modal-dialog" >
    <div class="modal-content">
      ...
      <form method="post" action="<?php echo base_url('admin/trash-webinar'); ?>" id="frmDel">
