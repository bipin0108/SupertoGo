...
<ul class="sidebar-menu" data-widget="tree">
  ...
  <li class="treeview <?php if($uri=='light-soil-schedule-list'|| $uri=='create-light-soil-schedule' || $uri=='edit-light-soil-schedule' || $uri=='medheavy-soil-schedule-list'|| $uri=='create-medheavy-soil-schedule' || $uri=='edit-medheavy-soil-schedule'){ echo 'active'; }?>">
    ...
    <!-- Webinar -->
    <li class="treeview <?php if($uri=='webinar-list'||$uri=='create-webinar' || $uri=='edit-webinar' || $uri=='webinar-payment-history'){ echo 'active'; }?>">
        <a href="#">
    ...
    <!-- User -->
    <li class="treeview <?php if($uri=='farmer-list'|| $uri=='buyer-list'|| $uri=='buyer-crop-rate-list' || $uri=='subscription-payment-history'){ echo 'active'; }?>">
        <a href="#">
        ...
        <ul class="treeview-menu">
          ...
          <!-- Buyer -->
          <li class="<?php if($uri=='buyer-list' || $uri=='buyer-crop-rate-list'){ echo 'active';}?>">
    ...
    <!-- Sub Admin -->
    <li class="treeview <?php if($uri=='subadmin-list'||$uri=='create-subadmin' || $uri=='edit-subadmin'){ echo 'active'; }?>">
        <a href="#">
        ...
        <ul class="treeview-menu">
          <li class="<?php if($uri=='create-subadmin'|| $uri=='add-subadmin'){echo'active';}?>"><a href="<?=base_url('admin/create-subadmin');?>"><i class="fa fa-plus"></i> Create</a></li>
          <li class="<?php if($uri=='subadmin-list'){ echo 'active';}?>"><a href="<?=base_url('admin/subadmin-list');?>"><i class="fa fa-list"></i>View</a></li>
        </ul>
    </li> 
    <!-- start Static Pages --> 
