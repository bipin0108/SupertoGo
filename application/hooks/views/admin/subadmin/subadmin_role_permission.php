...
$role_permission=$obj->subadminmodel->get_role_permission_by_user($user_id); 
?> 
    ...
    <h1>
      Role Permission
       <div class="pull-right">
        <a href="<?php echo base_url('admin/subadmin-list/'); ?>" class="btn btn-primary pull-right" > <i class="fa fa-angle-double-left" aria-hidden="true"></i>  Back to List</a>
      </div>
    </h1>
  </section>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          ...
          <form method="post" action="<?php echo base_url('admin/role-permission/'.$user_id) ?>">
