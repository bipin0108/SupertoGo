...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>Farmer Profile
      <a href="<?php echo base_url('admin/farmer-list') ?>" class="btn btn-primary pull-right">Back to Farmer List</a>
    </h1>
  </section>
                                  ...
                                  <?php foreach ($farmer_req as $req) { ?>
                                      <tr>
                                          ...
                                          <td style="display: inline-flex;">
                                            <a class="btn btn-sm btn-primary" href="<?php echo base_url('admin/view-advisory-request/'.$req->advisory_id); ?>" style="margin-right: 5px;">
                                              <i class="fa fa-eye"></i>
                                            </a>
                                          </td>
                                    </tr>       
