...
<?php 
$obj=&get_instance();
$buyer=$obj->usermodel->get_all_buyer(); 
?> 
                ...
                <?php foreach($buyer as $row) { 
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <img class=" img-responsive" style="height:35px;width:35px" src="<?php echo DEFAULT_IMG_PATH; ?>">  
                      <?php }else{ ?>
                      <img class=" img-responsive" style="height:35px;width:35px" src="<?php echo IMG_PATH.'user_profiles/'.$row->profile_pic; ?>">
                      <?php } ?>
                    </td>
                    ...
                    <?php if($role_permission->is_view == 1){ ?>
                      <a class="btn btn-sm btn-primary" href="<?php echo base_url('admin/buyer-crop-rate-list/'.$row->user_id); ?>">
                      Buyer Rate
                      </a>
                    <?php } ?>
                    </td>
