        ...
        <div class="col-md-3" >
          ...
          <div class="box box-primary" id="element_overlap">
            ...
            <?php if($user['profile_image'] == ''){ ?>
              <a data-magnify="gallery" data-caption=" " href="<?php echo DEFAULT_IMG_PATH; ?>">
              ...
              <?php }else{ ?>
              <a data-magnify="gallery" data-caption=" " href="<?php echo base_url('uploads/profiles/original/'.$user['profile_image']); ?>">
                <img class="profile-user-img img-responsive img-circle profileImgUrl" style="height:100px;width:100px" src="<?php echo base_url('uploads/profiles/original/'.$user['profile_image']); ?>">
              </a>  
            <?php } ?>
                    ...
                    <div class="row">
                      <div class="col-sm-4">
                          <?php 
                            ...
                            {
                              $img_src = base_url('uploads/profiles/original/').$p_img;
                            }
                            else
                            {
                          ...
                          ?>
                          <a data-magnify="gallery" data-caption=" " href="<?php echo $img_src; ?>">
                      ...
                      <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <input type="file" class="form-control" name="avatar_img" accept=".png,.jpg,.jpeg" >
                            </div>
                          </div>
                          <div class="form-group">
