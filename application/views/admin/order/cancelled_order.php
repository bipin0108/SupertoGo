          ...
          <div class="box-header">
            ...
            <form id="form-filter" class="form-horizontal">
              ...
              <div class="col-sm-2" style="display: inline-flex;">
                ...
                <a data-toggle="tooltip" data-placement="top" title="<?=lang('Download PDF');?>" target="_blank" href="<?php echo base_url(); ?>admin/cancelled-order-save-pdf?from=&to=" type="button" class="btn btn-primary export" ><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
                <a data-toggle="tooltip" data-placement="top" title="<?=lang('Download Excel');?>" target="_blank" href="<?php echo base_url(); ?>admin/cancelled-order-save-excel?from=&to=" type="button" class="btn btn-primary export" ><i class="fa fa-file-excel-o" aria-hidden="true"></i></a>
              </div>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo base_url(); ?>admin/cancelled-order-list-ajax",
            "type": "POST",
            "data": function ( data ) { 
                data.from = $('#from').val();
                data.to = $('#to').val();
