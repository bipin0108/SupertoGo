          ...
          <div class="box-header">
            ...
            <form id="form-filter" class="form-horizontal">
              ...
              <div class="col-sm-2" style="display: inline-flex;">
                <button data-toggle="tooltip" data-placement="top" title="Search" type="button" id="btn-filter" class="btn btn-primary"><i class="fa fa-filter" aria-hidden="true"></i></button>
                <button data-toggle="tooltip" data-placement="top" title="Refresh" type="button" id="btn-reset" class="btn btn-primary"><i class="fa fa-refresh" aria-hidden="true"></i></button>
                <a data-toggle="tooltip" data-placement="top" title="<?=lang('Download PDF');?>" target="_blank" href="<?php echo base_url(); ?>admin/running-order-save-pdf?from=&to=" type="button" class="btn btn-primary export" ><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
                <a data-toggle="tooltip" data-placement="top" title="<?=lang('Download Excel');?>" target="_blank" href="<?php echo base_url(); ?>admin/running-order-save-excel?from=&to=" type="button" class="btn btn-primary export" ><i class="fa fa-file-excel-o" aria-hidden="true"></i></a>
              </div>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo base_url(); ?>admin/running-order-list-ajax",
            "type": "POST",
            "data": function ( data ) { 
                data.from = $('#from').val();
                data.to = $('#to').val();
        ...
        "columnDefs": [
        { 
            "targets": [ 0,7 ], <?php //first column / numbering column ?>
