              ...
              <?php foreach($brand as $row) { ?>
                <tr>
                  ...
                  <td style="display: inline-flex;">
                      <a class="btn btn-sm btn-primary mr-5" href="<?php echo base_url('admin/edit-brand/'.$row['brand_id']); ?>">
                        <i class="fa fa-edit"></i>
                      </a>
                      <button data-i="<?php echo $row['brand_id']; ?>" class="btn btn-sm btn-danger mr-5 delete">
