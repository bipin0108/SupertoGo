          ...
          <div class="box-body table-responsive">
            ...
            ?>
              <tr>
                ...
                <td>
                  <label class='switch'>
                    <input type="checkbox" <?=$checked;?> class="active_deactive" data-is_value="<?=$row['status'];?>" data-i="<?=$row['db_id'];?>">
  ...
  $(function(){
    ...
    $(document).on('click', '.active_deactive', function(){
      ...
      var is_value = $(this).data('is_value');
       $.ajax({
             url:"<?php echo base_url(); ?>admin/ajax/deliveryBoyActiveDeactiveStatus",
             method:"POST",
